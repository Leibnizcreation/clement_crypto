...
mongoose.connect("mongodb://guest:guest@ds121588.mlab.com:21588/clement_crpto").then((conn) => console.log("connection to database was successful")).catch((err) => console.log("Error connecting to database"))
