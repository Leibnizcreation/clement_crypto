...
// mongoose.connect("mongodb://guest:guest@ds245478.mlab.com:45478/clement_crypto").then((conn) => console.log("connection to database was successful")).catch((err) => console.log("Error connecting to database"))
