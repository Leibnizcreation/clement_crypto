...
class BlackChip extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: '',
          ...
          <div className="row">
            ...
            <div className="col-md-7">
              <ul>
                ...
                <li>
                  7.5% Rakeback Paid By BTC Grinders(When you Rake at least $300
                  per weak)
                </li>
                <li>100% Deposit Bonus (up to $1000)</li>
                <li>+ All others Promotions</li>
              </ul>
            </div>
          </div>
...
export default connect(mapStateToProps, { addSite })(BlackChip);
